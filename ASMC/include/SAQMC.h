...
void SAQMC(double*, int, int, int, double*, int, int, gsl_rng*, ParamTransitionPF, ResamplingPF_QMC,  SimInitPF_QMC, SimTransitionPF_QMC,
PotentialPF, int*, double*, double*);

//void SAQMC_Forward(double*, int, int, int, double*, int, int, ParamTransitionPF, ResamplingBack_QMC,  SimInitPF_QMC, SimTransitionPF_QMC,
